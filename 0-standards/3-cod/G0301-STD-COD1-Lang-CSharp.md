...
# 15. 測定可能キー（YAML; cod.lang.csharp）
```yaml
version: 1
rules:
  cod.lang.csharp:
...
# 18. 改版履歴
- **0.2.2-draft (2025-10-27)** : XML Doc属性明記、同期ブロック検査方法を追記。
- **0.2.1-draft (2025-10-27)** : Doc整合性・アナライザ明記・YAMLキー強化。
- **0.2.0-draft (2025-10-27)** : 命名・非同期・YAMLキーを強化し、CI適合性を明確化。
- **0.1.0-draft (2025-10-27)** : 初版ドラフト。